...
export const HabitCard = ({
  ...
  const swipeMotion = useSwipeCardMotion({
    onSwipeLeft: archived ? undefined : onSwipeEdit,
    onSwipeRight: archived ? undefined : onSwipeArchive,
  })
  ...
  return (
    <SwipeActionPreview
      ...
      rightAction={
        archived
          ...
          : {
              icon: Archive,
              label: intl.formatMessage({ id: 'page.items.swipe.archive' }),
              tone: 'archive',
            }
      }
    ...
    >
      <Card
        ...
        className={cn(
          'group relative min-w-0 w-full max-w-full touch-pan-y overflow-hidden rounded-[1.35rem] border-border/80 bg-card p-4 transition-transform duration-200 ease-out motion-reduce:transition-none',
