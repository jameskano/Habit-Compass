...
export const getLocalePreferenceValueMessageId = (locale: AppLocale) => `settings.locale.${locale}`

export const getThemePreferenceValueMessageId = (theme: ThemePreference) =>
  `settings.theme.${theme}`

export const getWeekStartsOnPreferenceValueMessageId = (weekStartsOn: WeekStartsOnPreference) =>
