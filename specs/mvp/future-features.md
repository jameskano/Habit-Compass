...
- OAuth provider linking/unlinking and additional OAuth providers beyond Google.
- Production hosting for public legal pages and the external account-deletion request page.
- Analytics and automatic crash reporting, if separately approved and reflected in legal/Data Safety docs.
- Additional application languages beyond English and Spanish.
- Additional week-start days beyond Monday and Sunday.
